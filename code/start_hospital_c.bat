@echo off
REM Hospital C Client startup script
...
echo.
echo ============================================
echo Hospital C - Federated Learning Client
echo ============================================
echo.
echo This client will:
echo - Connect to the Federated Learning Server
echo - Train on local Hospital C dataset
...
python "%ROOT_DIR%\code\hospital3.py"

echo.
echo Hospital C Client stopped.
pause
